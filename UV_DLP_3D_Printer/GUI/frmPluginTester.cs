...
namespace UV_DLP_3D_Printer.GUI
{
    public partial class frmPluginTester : Form
    {
        ...
        {
            this.label1.Text = ((DesignMode) ? "PlugIn" : UVDLPApp.Instance().resman.GetString("PlugIn", UVDLPApp.Instance().cul));
            this.label2.Text = ((DesignMode) ? "PluginContents" : UVDLPApp.Instance().resman.GetString("PluginContents", UVDLPApp.Instance().cul));
            this.Text = ((DesignMode) ? "PlugInTester" : UVDLPApp.Instance().resman.GetString("PlugInTester", UVDLPApp.Instance().cul));
        ...
        private void frmPluginTester_Load(object sender, EventArgs e)
        {
