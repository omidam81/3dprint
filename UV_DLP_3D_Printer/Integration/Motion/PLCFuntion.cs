...
namespace UV_DLP_3D_Printer.Integration.Motion
{
    public class PLCFunction
    {
        ...
        public void SetStepZaxis(float step1,float step2)
        {
            PLC.SetSpreadStepZ1(step1);
            PLC.SetSpreadStepZ2(step2);
        }
        public void SpreadCycle()
        {
            PLC.SpreadCycle();
        }
        public void defineManualPrintParameter(ref bool bidirection, ref bool stitch, 
            ref int overlaps, ref int layers, ref int[] swathNumber)
        {
            ...
            bidirection = Convert.ToBoolean(temp);
        ...
        public void PrintLayer(bool Bidirection, bool PrintMainDirection, bool Stich, int Nb_Stich, int Overlaps, int Swaths)
        {
           ...
           // Console.WriteLine("YPostion initial value: ", YPosition);
            int i;
            ...
            for(i = 0; i< swaths; i++)
            {
                for (s =0; s<= Nb_Stich; s++)
                {
                    ...
                    {
                        //Console.WriteLine("Overlaps Nb : ", Count_Overlaps);
                        //Console.WriteLine("Stich Nb: ", Nb_Stich);
