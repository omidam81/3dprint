...
namespace UV_DLP_3D_Printer._3DEngine
{
    ...
    public class C2DGraphics
    {
        ...
        {
            //Bitmap bitmap = global::((DesignMode) ? "Arial" :UVDLPApp.Instance().resman.GetString("Arial", UVDLPApp.Instance().cul))butMinus;
                    ...
                    if (line.EndsWith(".png"))
                    {
                        ...
                        try
                        {
                            if (plugin != null)
                                ...
                                image = (Bitmap)Properties.Resource_s.ResourceManager.GetObject(imgname);
                            tw = image.Width;
                            th = image.Height;
        ...
        public C2DFont LoadFont(string name, string metrics)
        {
            ...
            if (img == null)
                return null;
            // string metrics = global::((DesignMode) ? "Arial" :UVDLPApp.Instance().resman.GetString("Arial", UVDLPApp.Instance().cul))ResourceManager.GetString(name + "_metrics");
            try
            {
