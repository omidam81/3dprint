...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class ctlMCZ : ctlMCBase
    {
        ...
        void UpdateOffsets()
        {
            int w = Properties.Resource_s.mc_z0.Width;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            DrawTextCentered(gr, ((DesignMode) ? "Pluse" :UVDLPApp.Instance().resman.GetString("Pluse", UVDLPApp.Instance().cul)) + mAxisSign, mCenterX, mCenterY - mArrowPos, atcol);
            DrawImageCentered(gr, mArrowD, mCenterX, mCenterY + mArrowPos);
            DrawTextCentered(gr, ((DesignMode) ? "_UnderLine" :UVDLPApp.Instance().resman.GetString("_UnderLine", UVDLPApp.Instance().cul)) + mAxisSign, mCenterX, mCenterY + mArrowPos, atcol);
