    ...
    public class ctlTextBox :TextBox
    {
        ...
        protected bool ValidateInt()
        {
            try
            {
                ...
                {
                    mErrMsg = ((DesignMode) ? "IntegerNumberOutOfRange" :UVDLPApp.Instance().resman.GetString("IntegerNumberOutOfRange", UVDLPApp.Instance().cul)) + MinInt + ((DesignMode) ? "To" :UVDLPApp.Instance().resman.GetString("To", UVDLPApp.Instance().cul)) + mIntMax + ((DesignMode) ? "Parenthesis" :UVDLPApp.Instance().resman.GetString("Parenthesis", UVDLPApp.Instance().cul));  
                    return false;
                }
                mIntVal = newval;
            }
            ...
            {
                mErrMsg = ((DesignMode) ? "InvalidIntegerNumber" :UVDLPApp.Instance().resman.GetString("InvalidIntegerNumber", UVDLPApp.Instance().cul));
                return false;
            }
            mErrMsg = null;
            return true;
        ...
        protected bool ValidateFloat()
        {
            try
            {
                ...
                {
                    mErrMsg = ((DesignMode) ? "RealNumberOutOfRange" :UVDLPApp.Instance().resman.GetString("RealNumberOutOfRange", UVDLPApp.Instance().cul)) + mFloatMin + ((DesignMode) ? "To" :UVDLPApp.Instance().resman.GetString("To", UVDLPApp.Instance().cul)) + mFloatMax + ((DesignMode) ? "Parenthesis" :UVDLPApp.Instance().resman.GetString("Parenthesis", UVDLPApp.Instance().cul));
                    return false;
                }
                mFloatVal = newval;
            }
