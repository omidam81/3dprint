...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class ctlScene : ctlAnchorable
    {
        ...
        public ctlScene()
        {
            ...
            //ctlTitle1.ForeColor = Color.FromArgb(255, 224, 224, 224);
            //treeScene.ForeColor = ct.ForeColor;
        ...
        {
            this.cmdRemoveObject.Text = ((DesignMode) ? "RemoveObject" : UVDLPApp.Instance().resman.GetString("RemoveObject", UVDLPApp.Instance().cul));
            this.ctlTitle1.Text = ((DesignMode) ? "Scene_" : UVDLPApp.Instance().resman.GetString("Scene_", UVDLPApp.Instance().cul));
        ...
        private void SetupSceneTree()
        {
            ...
            TreeNode scenenode = new TreeNode(((DesignMode) ? "Scene_" :UVDLPApp.Instance().resman.GetString("Scene_", UVDLPApp.Instance().cul)));
            ...
            foreach (Object3d obj in UVDLPApp.Instance().Engine3D.m_objects)
            {
                ...
                if(obj.tag == Object3d.OBJ_NORMAL)
                {
                    ...
                    {
                        TreeNode supnode = new TreeNode(((DesignMode) ? "Supports" :UVDLPApp.Instance().resman.GetString("Supports", UVDLPApp.Instance().cul)));
            ...
            if (selNode != null)
                selNode.BackColor = Color.FromArgb(255, 58, 85, 85);// Color.Green;
            scenenode.Expand();
        ...
        private void treeScene_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            if (e.Button == System.Windows.Forms.MouseButtons.Left && e.Node.Tag != null)
            {
                ...
                e.Node.BackColor = Color.FromArgb(255, 58, 85, 85);// Color.Green; // now set the selected color
