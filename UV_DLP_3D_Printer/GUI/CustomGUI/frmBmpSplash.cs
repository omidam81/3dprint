...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class frmBmpSplash : Form
    {
        ...
        {
            this.label1.Text = ((DesignMode) ? "_CreationWorkshop" : UVDLPApp.Instance().resman.GetString("_CreationWorkshop", UVDLPApp.Instance().cul));
            this.button1.Text = ((DesignMode) ? "SomeControl" : UVDLPApp.Instance().resman.GetString("SomeControl", UVDLPApp.Instance().cul));
        }
