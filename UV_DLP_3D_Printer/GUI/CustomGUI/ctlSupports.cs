...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class ctlSupports : ctlUserPanel
    {
        ...
        private const int opensize = 600;
        public ctlSupports()
        {
            InitializeComponent();
        ...
        {
            this.ctlToolTip1.SetToolTip(this.numFB, ((DesignMode) ? "FootBottomMm" : UVDLPApp.Instance().resman.GetString("FootBottomMm", UVDLPApp.Instance().cul)));
            this.ctlToolTip1.SetToolTip(this.buttGenBase, ((DesignMode) ? "AddSupportBasePlate" : UVDLPApp.Instance().resman.GetString("AddSupportBasePlate", UVDLPApp.Instance().cul)));
            this.ctlToolTip1.SetToolTip(this.buttAddSupport, ((DesignMode) ? "AddSupport" : UVDLPApp.Instance().resman.GetString("AddSupport", UVDLPApp.Instance().cul)));
            this.ctlToolTip1.SetToolTip(this.chkSupportAllScene, ((DesignMode) ? "CheckedSupportEntireSceneUncheckedSupportSelectedObjectsOnly" : UVDLPApp.Instance().resman.GetString("CheckedSupportEntireSceneUncheckedSupportSelectedObjectsOnly", UVDLPApp.Instance().cul)));
            this.ctlToolTip1.SetToolTip(this.numFB1, ((DesignMode) ? "FootBottomIntraMm" : UVDLPApp.Instance().resman.GetString("FootBottomIntraMm", UVDLPApp.Instance().cul)));
            this.numFT.TextFont = new System.Drawing.Font("Arial", 14F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel);
            this.ctlToolTip1.SetToolTip(this.numFT, ((DesignMode) ? "FootTopMm" : UVDLPApp.Instance().resman.GetString("FootTopMm", UVDLPApp.Instance().cul)));
            this.numHB.TextFont = new System.Drawing.Font("Arial", 14F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel);
            this.ctlToolTip1.SetToolTip(this.numHB, ((DesignMode) ? "HeadBottomMm" : UVDLPApp.Instance().resman.GetString("HeadBottomMm", UVDLPApp.Instance().cul)));
            this.numHT.TextFont = new System.Drawing.Font("Arial", 14F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel);
            this.ctlToolTip1.SetToolTip(this.numHT, ((DesignMode) ? "HeadTopMm" : UVDLPApp.Instance().resman.GetString("HeadTopMm", UVDLPApp.Instance().cul)));
            this.ctlToolTip1.SetToolTip(this.chkDownPolys, ((DesignMode) ? "ShowDownwardFacingSurfacesByAngle" : UVDLPApp.Instance().resman.GetString("ShowDownwardFacingSurfacesByAngle", UVDLPApp.Instance().cul)));
            ...
            this.ctlToolTip1.SetToolTip(this.numDownAngle, ((DesignMode) ? "DownwardFacingDegree" : UVDLPApp.Instance().resman.GetString("DownwardFacingDegree", UVDLPApp.Instance().cul)));
            ...
            this.ctlToolTip1.SetToolTip(this.numGap, ((DesignMode) ? "HorizontalGridSpacing" : UVDLPApp.Instance().resman.GetString("HorizontalGridSpacing", UVDLPApp.Instance().cul)));
            this.ctlToolTip1.SetToolTip(this.chkOnlyDownward, ((DesignMode) ? "GenerateSupportOnlyOnDownwardFacingSurfaces" : UVDLPApp.Instance().resman.GetString("GenerateSupportOnlyOnDownwardFacingSurfaces", UVDLPApp.Instance().cul)));
            this.numY.TextFont = new System.Drawing.Font("Arial", 14F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel);
            this.ctlToolTip1.SetToolTip(this.numY, ((DesignMode) ? "VerticalGridSpacing" : UVDLPApp.Instance().resman.GetString("VerticalGridSpacing", UVDLPApp.Instance().cul)));
            this.numX.TextFont = new System.Drawing.Font("Arial", 14F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel);
            this.ctlToolTip1.SetToolTip(this.numX, ((DesignMode) ? "HorizontalGridSpacing" : UVDLPApp.Instance().resman.GetString("HorizontalGridSpacing", UVDLPApp.Instance().cul)));
            this.cmdRemoveSupports.Text = ((DesignMode) ? "RemoveAll" : UVDLPApp.Instance().resman.GetString("RemoveAll", UVDLPApp.Instance().cul));
            this.Supports.Text = ((DesignMode) ? "Supports" : UVDLPApp.Instance().resman.GetString("Supports", UVDLPApp.Instance().cul));
            this.ctlTitle1.Text = ((DesignMode) ? "Supports" : UVDLPApp.Instance().resman.GetString("Supports", UVDLPApp.Instance().cul));
            this.ctlToolTip1.SetToolTip(this.buttAutoSupport, ((DesignMode) ? "GenerateAutomaticSupports" : UVDLPApp.Instance().resman.GetString("GenerateAutomaticSupports", UVDLPApp.Instance().cul)));
        }
            ...
            try
            {
                ...
                switch (cmbSupType.SelectedIndex) 
                {
                    ...
                    case 2:
                        ...
                        m_sc.eSupType = SupportConfig.eAUTOSUPPORTTYPE.TestMethod;
                        break;
                    case 3:
                        m_sc.eSupType = SupportConfig.eAUTOSUPPORTTYPE.eADAPTIVE3D;
                        break;
...
//                    case 2:
  //                      m_sc.eSupType = SupportConfig.eAUTOSUPPORTTYPE.eADAPTIVE2;
    //                    break;
                ...
                try
                {
                    switch (ev)
                    {
                        case SupportEvent.eCompleted:
                            ...
                            progressTitle.Text = ((DesignMode) ? "Supports" :UVDLPApp.Instance().resman.GetString("Supports", UVDLPApp.Instance().cul));
                        ...
                        case SupportEvent.eProgress:
                            ...
                            if (cs == 0) // set up the prog bar on the first step
                            {
                                ...
                                progressTitle.Text = ((DesignMode) ? "Generating" :UVDLPApp.Instance().resman.GetString("Generating", UVDLPApp.Instance().cul));
                            }
                            else
                            {
        ...
        private void UpdateForSupportType() 
        {
            switch (m_sc.eSupType)
            {
                case SupportConfig.eAUTOSUPPORTTYPE.eBON:
                    ...
                    labelAutoSup.Text = ((DesignMode) ? "AutomaticSupport" :UVDLPApp.Instance().resman.GetString("AutomaticSupport", UVDLPApp.Instance().cul));
                    label6.Visible = true;
                    label7.Visible = true;
                    numX.Visible = true;
                ...
                //case SupportConfig.eAUTOSUPPORTTYPE.eADAPTIVE2:
                    ...
                    labelAutoSup.Text = ((DesignMode) ? "MinimumGapMm" :UVDLPApp.Instance().resman.GetString("MinimumGapMm", UVDLPApp.Instance().cul));
        ...
        private void ctlTitle1_CheckChanged(object sender, bool newState)
        {
        ...
        private void ctlNumber1_Load(object sender, EventArgs e)
        {

        }

        private void numHT_Load(object sender, EventArgs e)
        {

        }

        private void ctlNumber1_ValueChanged(object sender, EventArgs e)
        {
            UVDLPApp.Instance().m_minimumSuportSize = this.numMinimumSupportSize.FloatVal;
        }

        private void ctlSupports_Load(object sender, EventArgs e)
        {
            numMinimumSupportSize.FloatVal = UVDLPApp.Instance().m_minimumSuportSize;
        }
    }
}
