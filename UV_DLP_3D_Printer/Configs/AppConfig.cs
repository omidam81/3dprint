...
namespace UV_DLP_3D_Printer
{
    ...
    public class AppConfig
    {
        ...
        public bool m_hideaboveslice; // hide the model abobve the shown slice
        ...
        public string m_Languages = "en, es";
        public string m_Lnaguages_Title = "Eglish, Spanish";
        public string m_Selected_Language = "en";
        ...
        public void CreateDefault() 
        {
            ...
            m_showOutline = false;
            m_showShaded = false;
            m_licensekey = "00000000000000000000";
            m_Languages = "en, es";
            m_Lnaguages_Title = "Eglish, Spanish";
            m_Selected_Language = "en";
        ...
        public bool Load(String filename) 
        {
            try
            {
                ...
                m_hideaboveslice = xh.GetBool(ac, "HideAboveSlice", false); 
                ...
                m_Languages = xh.GetString(ac, "Languages", "en, es");
                m_Lnaguages_Title = xh.GetString(ac, "LnaguagesTitle", "Eglish, Spanish");
                m_Selected_Language = xh.GetString(ac, "SelectedLanguage", "en");
        ...
        public bool Save(String filename) 
        {
            try
            {
                ...
                xh.SetParameter(ac, "HideAboveSlice", m_hideaboveslice);
                ...
                xh.SetParameter(ac, "Languages", m_Languages);
                xh.SetParameter(ac, "LnaguagesTitle", m_Lnaguages_Title);
                xh.SetParameter(ac, "SelectedLanguage", m_Selected_Language);
