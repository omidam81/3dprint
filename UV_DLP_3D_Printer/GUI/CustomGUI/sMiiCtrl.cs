...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class sMiiCtrl : UserControl
    {
     ...
     case 's':                             //LED UV off
        ...
        {
            this.cmdSend.Text = ((DesignMode) ? "SendCommand" : UVDLPApp.Instance().resman.GetString("SendCommand", UVDLPApp.Instance().cul));
        }
        ...
        private void cmdSend_Click(object sender, EventArgs e)
        {
            ...
            //send to the printer
            string txt = ((DesignMode) ? "M800T0" :UVDLPApp.Instance().resman.GetString("M800T0", UVDLPApp.Instance().cul)) + mc.command.ToString() + "\r\n";
            UVDLPApp.Instance().m_deviceinterface.SendCommandToDevice(txt);
        }

        private void sMiiCtrl_Load(object sender, EventArgs e)
        {
