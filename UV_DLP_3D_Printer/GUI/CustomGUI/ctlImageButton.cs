...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    ...
    { 
        ...
        void ScaleImage()
        {
            ...
            mFont = new System.Drawing.Font("Arial", (float)Height /3+4, GraphicsUnit.Pixel);
            Invalidate();
        }
        ...
        void OnPaint1(Graphics gr, Image inimg)
        {
            ...
            gr.FillRectangle(new SolidBrush(BackColor), dstrc);
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            {
                using (Brush br = new SolidBrush(Color.FromArgb(255, 146, 146, 146)))// GetPaintColor(Style)))
                {
                    if (mTextLen <= 0)
            ...
            switch (mCtlState)
            {
                ...
                case CtlState.Normal:
                    if (Checked)
                        col = stl.CheckedColor;
                    //else 
                    //    col = Color.FromArgb(255, 58, 85, 85);
                    break;
    ...
    public class ctlImageButtonEx : Button
    {
        public Image HoverImage { get; set; }
        public string OnClickCallback { get; set; } = null;
        //private Image main;
        private bool _isToggle;
        public Color Color { get; set; } //= Color.FromArgb(255, 32, 174, 196);
        ...
        {
            get => _isToggle;
            set { _isToggle = value; ChangeState(value); }
        }

        public ctlImageButtonEx()
        {
            InitializeComponent();
        ...
        public void DoClick(EventArgs e)
        {
            ...
            if (OnClickCallback == null)
                return;
            var retobj = UVDLPApp.Instance().m_callbackhandler.Activate(OnClickCallback, this);
            ...
            try
            {
                ...
                {
                    // try to execute it as a sequence
                    SequenceManager.Instance().ExecuteSequence(OnClickCallback);
                }
            }
            catch (Exception) { }
        }

        public void ChangeState(bool toggle)
        {
            if (toggle)
            {
                BackColor = Color;
        ...
        private void InitializeComponent()
        {
            ...
            ForeColor = Color = Color.FromArgb(255, 32, 174, 196);
    ...
    public class ctlImageEx : PictureBox
    {
        public Image HoverImage { get; set; }
        public string OnClickCallback { get; set; } = null;
        //private Image main;
