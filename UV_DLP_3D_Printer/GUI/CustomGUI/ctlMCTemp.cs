...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class ctlMCTemp : ctlMCBase
    {
        ...
        public ctlMCTemp()
        {
            ...
            mTMin = 0;
            mTMax = 300;
            Font = new Font(((DesignMode) ? "Arial" :UVDLPApp.Instance().resman.GetString("Arial", UVDLPApp.Instance().cul)), 16, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Pixel, ((byte)(0)));
            mTempBgnd = Properties.Resource_s.mc_temper;
            mBgndPos = 20;
            ...
            mTempSign = ((DesignMode) ? "Sign" :UVDLPApp.Instance().resman.GetString("Sign", UVDLPApp.Instance().cul));
            mUnit = ((DesignMode) ? "C_" :UVDLPApp.Instance().resman.GetString("C_", UVDLPApp.Instance().cul));
            mOverPointer = false;
            mPointOffs = 9999;
        ...
        {
            this.textSetTemp.Text = ((DesignMode) ? "_0" : UVDLPApp.Instance().resman.GetString("_0", UVDLPApp.Instance().cul));
        }
