...
using UV_DLP_3D_Printer.Integration.Integration;
...
namespace UV_DLP_3D_Printer
{
    ...
    {
        public IntegrationFunction IntegrationFunction = new IntegrationFunction();
        ...
        public float m_minimumSuportSize = 10.0f;
        ...
        */
        ...
        void FileExportCallback(object sender, object data)
        {
            string[] args = (string[])data;
            if (args.Length > 0)
            {
                m_exporter.SelectType(args[0]);
            }
            m_exporter.ShowDialog();
        }
