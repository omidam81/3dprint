...
namespace UV_DLP_3D_Printer.GUI.Controls
{
    public partial class ctlUserParamEdit : UserControl
    {
        ...
        {
            this.label1.Text = ((DesignMode) ? "UserParameters" : UVDLPApp.Instance().resman.GetString("UserParameters", UVDLPApp.Instance().cul));
            this.label2.Text = ((DesignMode) ? "Name" : UVDLPApp.Instance().resman.GetString("Name", UVDLPApp.Instance().cul));
            this.label3.Text = ((DesignMode) ? "Value" : UVDLPApp.Instance().resman.GetString("Value", UVDLPApp.Instance().cul));
            this.columnHeader1.Text = ((DesignMode) ? "Name" : UVDLPApp.Instance().resman.GetString("Name", UVDLPApp.Instance().cul));
            this.columnHeader2.Text = ((DesignMode) ? "Value" : UVDLPApp.Instance().resman.GetString("Value", UVDLPApp.Instance().cul));
        }
