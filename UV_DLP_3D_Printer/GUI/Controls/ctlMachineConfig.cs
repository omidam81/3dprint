...
namespace UV_DLP_3D_Printer.GUI.Controls
{
    public partial class ctlMachineConfig : UserControl //ctlUserPanel //
    {
        ...
        public ctlMachineConfig()
        {
            ...
            SetTexts();
            //tabControl1.TabPages.Remove(tbParameters);
        }

        private void SetTexts()
        {
            this.Monitors.Text = ((DesignMode) ? "AvailableDisplays" : UVDLPApp.Instance().resman.GetString("AvailableDisplays", UVDLPApp.Instance().cul));
            this.cmdRefreshMonitors.Text = ((DesignMode) ? "Refresh" : UVDLPApp.Instance().resman.GetString("Refresh", UVDLPApp.Instance().cul));
            this.groupBox1.Text = ((DesignMode) ? "BuildSizeMm" : UVDLPApp.Instance().resman.GetString("BuildSizeMm", UVDLPApp.Instance().cul));
            this.cmdAdjust.Text = ((DesignMode) ? "Adjust" : UVDLPApp.Instance().resman.GetString("Adjust", UVDLPApp.Instance().cul));
            this.label3.Text = ((DesignMode) ? "Z" : UVDLPApp.Instance().resman.GetString("Z", UVDLPApp.Instance().cul));
            this.txtPlatTall.Text = ((DesignMode) ? "_200" : UVDLPApp.Instance().resman.GetString("_200", UVDLPApp.Instance().cul));
            ...
            //this.grpPrjSerial.Text = ((DesignMode) ? "ProjectorControl" : UVDLPApp.Instance().resman.GetString("ProjectorControl", UVDLPApp.Instance().cul));
            //this.chkEnableMask.Text = ((DesignMode) ? "EnableMask" : UVDLPApp.Instance().resman.GetString("EnableMask", UVDLPApp.Instance().cul));
            //this.cmdConfigMask.Text = ((DesignMode) ? "ConfigureMask" : UVDLPApp.Instance().resman.GetString("ConfigureMask", UVDLPApp.Instance().cul));
            this.checkConDispEnable.Text = ((DesignMode) ? "EnableSerial" : UVDLPApp.Instance().resman.GetString("EnableSerial", UVDLPApp.Instance().cul));
            this.label12.Text = ((DesignMode) ? "Port__" : UVDLPApp.Instance().resman.GetString("Port__", UVDLPApp.Instance().cul));
            this.cmdCfgConDsp.Text = ((DesignMode) ? "ConfigurePort" : UVDLPApp.Instance().resman.GetString("ConfigurePort", UVDLPApp.Instance().cul));
            this.grpMachineConfig.Font = new System.Drawing.Font(((DesignMode) ? "MicrosoftSansSerif" : UVDLPApp.Instance().resman.GetString("MicrosoftSansSerif", UVDLPApp.Instance().cul)), 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.grpMachineConfig.Text = ((DesignMode) ? "Name" : UVDLPApp.Instance().resman.GetString("Name", UVDLPApp.Instance().cul));
            this.groupMCControls.Text = ((DesignMode) ? "MachineControls" : UVDLPApp.Instance().resman.GetString("MachineControls", UVDLPApp.Instance().cul));
            this.checkMCSutter.Text = ((DesignMode) ? "Shutter__" : UVDLPApp.Instance().resman.GetString("Shutter__", UVDLPApp.Instance().cul));
            this.labelPressApply.Text = ((DesignMode) ? "PressApplyToApplyChanges" : UVDLPApp.Instance().resman.GetString("PressApplyToApplyChanges", UVDLPApp.Instance().cul));
            this.checkMCGCode.Text = ((DesignMode) ? "ManualGCode_" : UVDLPApp.Instance().resman.GetString("ManualGCode_", UVDLPApp.Instance().cul));
            this.checkMCProjector.Text = ((DesignMode) ? "ProjectorControl" : UVDLPApp.Instance().resman.GetString("ProjectorControl", UVDLPApp.Instance().cul));
            this.checkMCBed.Text = ((DesignMode) ? "HeatedPlatform" : UVDLPApp.Instance().resman.GetString("HeatedPlatform", UVDLPApp.Instance().cul));
            this.checkMCHeater.Text = ((DesignMode) ? "ExtruderHeater" : UVDLPApp.Instance().resman.GetString("ExtruderHeater", UVDLPApp.Instance().cul));
            this.checkMCExtrude.Text = ((DesignMode) ? "ExtruderMotor" : UVDLPApp.Instance().resman.GetString("ExtruderMotor", UVDLPApp.Instance().cul));
            this.checkMCTilt.Text = ((DesignMode) ? "TiltControl" : UVDLPApp.Instance().resman.GetString("TiltControl", UVDLPApp.Instance().cul));
            this.checkMCZ.Text = ((DesignMode) ? "ZAxis" : UVDLPApp.Instance().resman.GetString("ZAxis", UVDLPApp.Instance().cul));
            ...
            //this.tbConfig.Text = ((DesignMode) ? "MachineConfig" : UVDLPApp.Instance().resman.GetString("MachineConfig", UVDLPApp.Instance().cul));
            //this.tbParameters.Text = ((DesignMode) ? "UserParameters" : UVDLPApp.Instance().resman.GetString("UserParameters", UVDLPApp.Instance().cul));
            this.Font = new System.Drawing.Font(((DesignMode) ? "MicrosoftSansSerif" : UVDLPApp.Instance().resman.GetString("MicrosoftSansSerif", UVDLPApp.Instance().cul)), 10.2F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void cmdOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //{
                //    MessageBox.Show(((DesignMode) ? "YouMustConfigureAtLeast1DisplayDevice" :UVDLPApp.Instance().resman.GetString("YouMustConfigureAtLeast1DisplayDevice", UVDLPApp.Instance().cul)));
                //}
                UVDLPApp.Instance().IntegrationFunction.SetConfig(m_config);
                UVDLPApp.Instance().IntegrationFunction.initializationCommunication();
            }
            catch (Exception ex) 
            {
                DebugLogger.Instance().LogError(ex);
        ...
        private void checkConDispEnable_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cmdCfgConDsp.Enabled= checkConDispEnable.Checked;
...
//            m_config.m_lstMonitorconfigs.Remove(lbConfigured.SelectedIndex);
        ...
        private void ShowMicron() 
        {
            try
            {
                lblMicronX.Text = string.Format(((DesignMode) ? "_00MicronsX" :UVDLPApp.Instance().resman.GetString("_00MicronsX", UVDLPApp.Instance().cul)),(( m_config.m_PlatXSize / m_config.XRenderSize)*1000));
                lblMicronY.Text = string.Format(((DesignMode) ? "_00MicronsY" :UVDLPApp.Instance().resman.GetString("_00MicronsY", UVDLPApp.Instance().cul)), ((m_config.m_PlatYSize / m_config.YRenderSize) * 1000));
            }
            catch (Exception ) 
            {
        ...
        {
            numHeater.Enabled = btnHeater.Enabled = chkHeater.Checked;
        }

        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            numRoller.Enabled = btnRoller.Enabled = chkRoller.Checked;
        }
