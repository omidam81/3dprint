...
namespace UV_DLP_3D_Printer.GUI
{
    public partial class frmCalibResin : Form
    {
        ...
        private void buttPrint_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show(((DesignMode) ? "TestModelGenerationCompletedCloseTheCalibrationFormAndPressPLAYButtonToPrint" :UVDLPApp.Instance().resman.GetString("TestModelGenerationCompletedCloseTheCalibrationFormAndPressPLAYButtonToPrint", UVDLPApp.Instance().cul)), ((DesignMode) ? "TestModelGeneration" :UVDLPApp.Instance().resman.GetString("TestModelGeneration", UVDLPApp.Instance().cul)));
