...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public class ctlMCShutter : ctlMCBase
    {
        ...
        public ctlMCShutter()
        {
            ...
            mSOpen = Properties.Resource_s.mc_shuttopen;
            mSClose = Properties.Resource_s.mc_shuttclose;
            ...
            mTitle = ((DesignMode) ? "Shutter" :UVDLPApp.Instance().resman.GetString("Shutter", UVDLPApp.Instance().cul));
        }
