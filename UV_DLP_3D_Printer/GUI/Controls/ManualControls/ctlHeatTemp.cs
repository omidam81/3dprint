...
{   
    ...
    public partial class ctlHeatTemp : ctlUserPanel
    {
        ...
        {
            this.cmdOff1.Text = ((DesignMode) ? "Off" : UVDLPApp.Instance().resman.GetString("Off", UVDLPApp.Instance().cul));
            this.cmdOff2.Text = ((DesignMode) ? "Off" : UVDLPApp.Instance().resman.GetString("Off", UVDLPApp.Instance().cul));
            this.cmdSet2.Text = ((DesignMode) ? "Set" : UVDLPApp.Instance().resman.GetString("Set", UVDLPApp.Instance().cul));
            this.chkMonitorTemps.Text = ((DesignMode) ? "MonitorTemperature" : UVDLPApp.Instance().resman.GetString("MonitorTemperature", UVDLPApp.Instance().cul));
            this.label2.Text = ((DesignMode) ? "Heater1Ext0" : UVDLPApp.Instance().resman.GetString("Heater1Ext0", UVDLPApp.Instance().cul));
            this.label1.Text = ((DesignMode) ? "Heater2HBP" : UVDLPApp.Instance().resman.GetString("Heater2HBP", UVDLPApp.Instance().cul));
