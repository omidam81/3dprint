...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class ctlMCXY : ctlMCBase
    {
        ...
        {
            int w = Properties.Resource_s.mc_px0.Width;
            int h = Properties.Resource_s.mc_px0.Height;
        ...
        protected override void UpdateBitmaps()
        {
            ...
            mArches[0] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px3, mLevelColors[0]);
            mArches[1] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px2, mLevelColors[1]);
            mArches[2] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px1, mLevelColors[2]);
            mArches[3] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px0, mLevelColors[3]);

            mArchesSel[0] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px3, mSelColor);
            mArchesSel[1] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px2, mSelColor);
            mArchesSel[2] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px1, mSelColor);
            mArchesSel[3] = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_px0, mSelColor);
            // center
            mCentImg = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_cent, mLevelColors[3]);
            mCentImgSel = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_cent, mSelColor);
            // corners
            mYHomeImg = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_trcorner, mFrameColor);
            mYHomeImgSel = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_trcorner, mSelColor);
            mXHomeImg = C2DGraphics.RotateBmp90deg(mYHomeImg, 3);
            mXHomeImgSel = C2DGraphics.RotateBmp90deg(mYHomeImgSel, 3);
            Bitmap brCorner = C2DGraphics.RotateBmp90deg(Properties.Resource_s.mc_trcorner, 1);
            ...
            // arrows
            mArrowU = C2DGraphics.ColorizeBitmapHQ(Properties.Resource_s.mc_uparrow, mArrowCol);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (lvl >= 0)
            {
                ...
                if ((lvl >= 0) && (lvl <= 3))
                {
                    ...
                    String txt = (mSelLevel < 0) ? ((DesignMode) ? "_UnderLine" :UVDLPApp.Instance().resman.GetString("_UnderLine", UVDLPApp.Instance().cul)) : "";
            ...
            DrawTextCentered(gr, ((DesignMode) ? "Y_" :UVDLPApp.Instance().resman.GetString("Y_", UVDLPApp.Instance().cul)), mCircWidth - mButHomePos, mButHomePos + 4, issel ? mSelColor : mFrameColor);
            ...
            DrawTextCentered(gr, ((DesignMode) ? "X_" :UVDLPApp.Instance().resman.GetString("X_", UVDLPApp.Instance().cul)), mButHomePos, mButHomePos + 4, issel ? mSelColor : mFrameColor);
            ...
            DrawTextCentered(gr, ((DesignMode) ? "All" :UVDLPApp.Instance().resman.GetString("All", UVDLPApp.Instance().cul)), mCircWidth - mButHomePos + 2, mCircWidth - mButHomePos + 4, issel ? mSelColor : mFrameColor);

            // arrows
            Color atcol = Color.FromArgb(120, 0, 0, 0);
            DrawImageCentered(gr, mArrowU, mCenter, mCenter - mArrowPos);
            DrawTextCentered(gr, ((DesignMode) ? "Y___" :UVDLPApp.Instance().resman.GetString("Y___", UVDLPApp.Instance().cul)), mCenter, mCenter - mArrowPos, atcol);
            DrawImageCentered(gr, mArrowR, mCenter + mArrowPos, mCenter);
            DrawTextCentered(gr, ((DesignMode) ? "X__pluse" :UVDLPApp.Instance().resman.GetString("X__pluse", UVDLPApp.Instance().cul)), mCenter + mArrowPos, mCenter, atcol);
            DrawImageCentered(gr, mArrowD, mCenter, mCenter + mArrowPos);
            DrawTextCentered(gr, ((DesignMode) ? "Y_" :UVDLPApp.Instance().resman.GetString("Y_", UVDLPApp.Instance().cul)), mCenter, mCenter + mArrowPos, atcol);
            DrawImageCentered(gr, mArrowL, mCenter - mArrowPos, mCenter);
            DrawTextCentered(gr, ((DesignMode) ? "X___" :UVDLPApp.Instance().resman.GetString("X___", UVDLPApp.Instance().cul)), mCenter - mArrowPos, mCenter, atcol);
