...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    ...
    public class Render3DStyle
    {
        public Render3DStyle()
        {
            this.frameColor = new GuiParam<Color>();
            this.baseColor = new GuiParam<Color>();
            this.textColor = new GuiParam<Color>();
            this.objectColor = new GuiParam<Color>();   
            this.selectColor = new GuiParam<Color>();
            this.multiselColor = new GuiParam<Color>();
            this.supportColor = new GuiParam<Color>();
            this.show3DIndicator = new GuiParam<bool>();
            this.showBaseIndicators = new GuiParam<bool>();
        }
        public GuiParam<Color> frameColor;
        public GuiParam<Color> baseColor;
        public GuiParam<Color> textColor;
        public GuiParam<Color> objectColor;
        public GuiParam<Color> selectColor;
        public GuiParam<Color> multiselColor;
        public GuiParam<Color> supportColor;
        public GuiParam<bool> showBaseIndicators;
        public GuiParam<bool> show3DIndicator;
    }
    ...
    public class GuiControlStyle
    {
        ...
        public virtual void SetDefault()
        {
            ...
            //ForeColor = new GuiParam<Color>(Color.Black);
            //BackColor = new GuiParam<Color>(Color.FromArgb(60, 0, 0, 120));
        ...
        public void CopyFrom(GuiControlStyle sctl)
        {
            ...
            maxDepth = sctl.maxDepth.GetCopy();
        ...
        public void InheritFrom(GuiControlStyle sctl)
        {
            ...
            maxDepth.InheritFrom(sctl.maxDepth);
        ...
        public C9Patch BackImage9Patch
        {
            get
            {
                if ((mBackImage9PCache == null) && (BackImageCache != null) && ((string)mBackImage).StartsWith(UVDLPApp.Instance().resman.GetString("_9p", UVDLPApp.Instance().cul)))
    ...
    public class GuiButton : GuiControl
    {
        ...
        public GuiParam<bool> checkState;
    ...
    */
    ...
    public class GuiConfigDB
    {
       ...
       // public enum EntityType { Buttons, Panels, Decals } // not used
        ...
        public Render3DStyle RenderStyle;
        ...
        public GuiConfigDB()
        {
            ...
            */
            ...
            Res = Properties.Resource_s.ResourceManager;
            Plugin = null;
        ...
        {
            get { return GetDecorListByLevel("foreground"); }
        }
        ...
        void LoadSequence(XmlNode seqnode) 
        {
            try
            {
                ...
                if (!name.IsExplicit())
                {
                    DebugLogger.Instance().LogWarning(UVDLPApp.Instance().resman.GetString("SequenceMustHaveANameInGUIConfig", UVDLPApp.Instance().cul));
                    return;
                }
                //get sequence
                string seq = GetStrParam(seqnode, UVDLPApp.Instance().resman.GetString("Seqdata", UVDLPApp.Instance().cul), "");
                //get type
                string seqtype = GetStrParam(seqnode, UVDLPApp.Instance().resman.GetString("Seqtype", UVDLPApp.Instance().cul), "");
                if (seqtype.ToLower().Equals(UVDLPApp.Instance().resman.GetString("Gcode", UVDLPApp.Instance().cul)))
                {                    
                    CommandSequence gcs = new GCodeSequence(name, seq);
                    CmdSequenceList.Add(gcs);
                }
                if (seqtype.ToLower().Equals(UVDLPApp.Instance().resman.GetString("Process", UVDLPApp.Instance().cul)))
                {
                    ...
                    foreach (XmlNode nd in seqnode)
                    {
                        switch (nd.Name.ToLower())
                        {
                            case "processentry":
                                ...
                                pe.args = GetStrParam(nd,UVDLPApp.Instance().resman.GetString("Args", UVDLPApp.Instance().cul), "");
                                pe.processname = GetStrParam(nd, UVDLPApp.Instance().resman.GetString("Processname", UVDLPApp.Instance().cul), "");
                                pe.wait = GetBoolParam(nd, UVDLPApp.Instance().resman.GetString("Waitfor", UVDLPApp.Instance().cul), false);
                                pe.windowstyle = GetStrParam(nd,
                                    UVDLPApp.Instance().resman.GetString("Windowstyle", UVDLPApp.Instance().cul),
                                    UVDLPApp.Instance().resman.GetString("Normal", UVDLPApp.Instance().cul));
                ...
                else
                {
                    DebugLogger.Instance()
                        .LogWarning(
                            UVDLPApp.Instance().resman.GetString("UnknownSequenceType", UVDLPApp.Instance().cul) +
                            seqtype + UVDLPApp.Instance().resman.GetString("InGUIConfig", UVDLPApp.Instance().cul));
                }
            }
            catch (Exception ex) 
            {
        ...
        void HandleDecals(XmlNode decalnode)
        {
            ...
            foreach (XmlNode xnode in decalnode.ChildNodes)
            {
                switch (xnode.Name)
                {
                    ...
                    case "renderstyle": HandleRenderStyle(xnode); break;
                }
            }
        }
        ...
        void HandleRenderStyle(XmlNode stlnode)
        {
            RenderStyle.frameColor = GetColorParam(stlnode, "framecolor", RenderStyle.frameColor);
            RenderStyle.baseColor = GetColorParam(stlnode, "basecolor", RenderStyle.baseColor);
            RenderStyle.textColor = GetColorParam(stlnode, "textcolor", RenderStyle.textColor);
            RenderStyle.objectColor = GetColorParam(stlnode, "objectcolor", RenderStyle.objectColor);
            RenderStyle.selectColor = GetColorParam(stlnode, "selectcolor", RenderStyle.selectColor);
            RenderStyle.multiselColor = GetColorParam(stlnode, "multiselcolor", RenderStyle.multiselColor);
            RenderStyle.supportColor = GetColorParam(stlnode, "supportcolor", RenderStyle.supportColor);
            RenderStyle.show3DIndicator = GetBoolParam(stlnode, "axisindicator", RenderStyle.show3DIndicator);
            RenderStyle.showBaseIndicators = GetBoolParam(stlnode, "baseindicators", RenderStyle.showBaseIndicators);
        }
...
//            butt.Visible = true;
            ...
            butt.checkState = GetBoolParam(buttnode, "checked", false);
            /* move to manager
        ...
        */
        ...
        public static GuiParam<string> GetStrParam(XmlNode xnode, string paramName, object defVal)
        {
            ...
            try
            {
                if (xnode.Attributes != null && xnode.Attributes.Count > 0 && xnode.Attributes[paramName] != null)
        ...
        public static Color ParseColor(string cname)
        {
            ...
            else
            {
                ...
                if (res.ToArgb() == 0)
                    throw new Exception(UVDLPApp.Instance().resman.GetString("BadColorName", UVDLPApp.Instance().cul));
            }
            return res;
        }
        ...
        void UpdateStyle(XmlNode xnode, GuiControlStyle ct)
        {
            ...
            ct.maxDepth = GetIntParam(xnode, "maxapplydepth", ct.maxDepth);
        ...
        public void SaveConfiguration(string fileName)
        {
            ...
            {
                DebugLogger.Instance().LogError("UnableToSaveGUIConfiguration" + ex.Message);
            }
        }
        ...
        public void SaveConfiguration(MemoryStream ms)
        {
            ...
            {
                DebugLogger.Instance().LogError(UVDLPApp.Instance().resman.GetString("UnableToSaveGUIConfiguration", UVDLPApp.Instance().cul) + ex.Message);
            }
        }
        ...
        void SaveStyle(XmlDocument xd, XmlNode xnode, GuiControlStyle stl)
        {
            ...
            stl.maxDepth.Save(xd, xnode, "maxapplydepth");
        ...
        void SaveButtonDefs(XmlDocument xd, XmlNode parent)
        {
            foreach (KeyValuePair<string, GuiButton> pair in GuiButtonsDict)
            {
                ...
                butt.checkState.Save(xd, bnode, "checked");
        ...
        void SaveRenderStyle(XmlDocument xd, XmlNode parent)
        {
            Render3DStyle rs = RenderStyle;
            XmlNode rsnode = xd.CreateElement("renderstyle");
            rs.frameColor.Save(xd, rsnode, "framecolor");
            rs.baseColor.Save(xd, rsnode, "basecolor");
            rs.textColor.Save(xd, rsnode, "textcolor");   
            rs.objectColor.Save(xd, rsnode, "objectcolor");
            rs.selectColor.Save(xd, rsnode, "selectcolor");
            rs.multiselColor.Save(xd, rsnode, "multiselcolor");
            rs.supportColor.Save(xd, rsnode, "supportcolor");
            rs.show3DIndicator.Save(xd, rsnode, "axisindicator");
            rs.showBaseIndicators.Save(xd, rsnode, "baseindicators");
            if (rsnode.ChildNodes.Count > 0)
                parent.AppendChild(rsnode);
        }
