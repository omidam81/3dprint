...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public partial class ctlInfoItem : ctlUserPanel
    {
        ...
        public ctlInfoItem()
        {
            ...
            //    BackColor =
            //    TitleBackColor =
            //    DataBackColor = Wcolor.BackColor;
            //DataColor =  TitleColor = Wcolor.ForeColor;
        }

        private void SetTexts()
        {
            this.labelTitle.Text = (DesignMode) ? "" : ((DesignMode) ? "Title____" : UVDLPApp.Instance().resman.GetString("Title____", UVDLPApp.Instance().cul));
            this.labelData.Text = ((DesignMode) ? "Data" : UVDLPApp.Instance().resman.GetString("Data", UVDLPApp.Instance().cul));
        }
