    ...
    public class Support : Cylinder3d
    {
       ...
       // private int mSC.cdivs; // number of circular divisions
        ...
        public void Create(SupportConfig SC, Object3d supporting, float d1, float d2, float d3)
        {
            try
            {
                ...
                SetColor(UVDLPApp.Instance().Engine3D.m_supportColor);
        ...
        */
        ...
        public void Select(Polygon ply) 
        {
            ...
            {
                m_lstpolys[c].m_color = UVDLPApp.Instance().Engine3D.m_supportColor;
            }
        }
        ...
        private void JustMoveObject(double delta_height)
        {
            foreach (var point in m_lstpoints)
            {
                point.z += (float)delta_height;
            }
            this.InvalidateList();
        }
             ...
             if (m_listid == -1)
             {
                 ...
                 foreach (Polygon poly in m_lstpolys)
                 {
                     ...
                     if (selected) // object selected
                     {
                            ...
                            {
                                clr = UVDLPApp.Instance().Engine3D.m_selectColor;
                            }
