...
namespace UV_DLP_3D_Printer.GUI.CustomGUI.Expanding
{
    public partial class ctlMoveExpand : ctlUserPanel
    {
        ...
        {
            this.ctlTitle1.Text = ((DesignMode) ? "Move_" : UVDLPApp.Instance().resman.GetString("Move_", UVDLPApp.Instance().cul));
            ...
            this.ctlToolTip1.SetToolTip(this.buttCenter, ((DesignMode) ? "CenterObject" : UVDLPApp.Instance().resman.GetString("CenterObject", UVDLPApp.Instance().cul)));
        ...
        {
            UVDLPApp.Instance().m_gui_config.AddButton(parentName + ((DesignMode) ? "Title" :UVDLPApp.Instance().resman.GetString("Title", UVDLPApp.Instance().cul)), ctlTitle1);
        }
    }
}
