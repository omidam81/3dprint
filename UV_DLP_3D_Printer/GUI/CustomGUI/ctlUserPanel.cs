...
namespace UV_DLP_3D_Printer.GUI.CustomGUI
{
    public class ctlUserPanel : UserControl
    {
        ...
        public ctlUserPanel()
            : base()
        {
            bgndPanel.col = Color.Transparent;
        ...
        protected override void OnPaintBackground(PaintEventArgs e)
        {
            if (GLDisplay)
                return;
            Color col = Color.FromArgb(255, 224, 224, 224);// Color.Gray;// Style.BackColor;
            if (!mWinPlatform)
        ...
        public virtual void OnGLBackgroundPaint(C2DGraphics gr)
        {
            ...
            gr.Rectangle(0, 0, Width, Height, Color.FromArgb(255, 224, 224, 224));
        }
